...
const Banner = () => {
    return (
        <div className="carousel w-full h-[90vh] text-white">
            {/* Slide 1 */}
            <div id="slide1" className="carousel-item relative w-full bg-[url(https://i.postimg.cc/zXSLW4Gh/priscilla-du-preez-JCZ2p-E-Szpw-unsplash.jpg)] bg-cover bg-center h-[75vh]">
                {/* Dark overlay */}
            ...
            {/* Slide 3 */}
            <div id="slide3" className="carousel-item relative w-full bg-[url(https://i.postimg.cc/t70gPtL2/vadim-kaipov-8-ZELrod-Sv-Tc-unsplash.jpg)] bg-cover bg-center h-[75vh]">
                {/* Dark overlay */}
                <div className="absolute inset-0 bg-black/30"></div>
            ...
            {/* Slide 4 */}
            <div id="slide4" className="carousel-item relative w-full bg-[url(https://i.postimg.cc/TPTpC0hs/chris-lawton-cfl3-Fij-Ygl-M-unsplash.jpg)] bg-cover bg-center h-[75vh]">
                {/* Dark overlay */}
                <div className="absolute inset-0 bg-black/30"></div>
